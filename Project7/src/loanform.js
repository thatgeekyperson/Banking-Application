  ...
  return (
    <div className="pad">
      ...
      <form action = "http://localhost:5000/loanform" method = "POST">
        ...
        Applicant Income(in $ per month): <input type="number" Name="applicant_income"></input><br/><br/>

        LoanAmount(in $): <input type="number" Name="loan_amount"></input><br/><br/>

        Loan Amount Term(number of months): <input type="number" Name="loan_term"></input><br/><br/>
